         ...
         <div class="col">
            <div class="header-tools justify-content-end">
               ...
               <div class="header-search">
                  <a href="#offcanvas-search" class="offcanvas-toggle"><i class="fas fa-call"></i></a>
               </div>
               <div class="header-cart">
                  <a href="#offcanvas-cart" class="offcanvas-toggle"><i class="fas fa-shopping-cart"></i></a>
               </div>
               <div class="header-login">
   ...
   <div class="site-menu-section section">
      <div class="container">
         <nav class="site-main-menu justify-content-center">
            <ul>
               <li class="<?php if(Request()->segment(1) == ''){ echo 'active';}else{ echo '';} ?>">
               ...
               <li class="">
                  <!-- <a href="{{ route('/') }}"><span class="menu-text">Track Order </span></a> -->
               </li>
            </ul>
         </nav>
      </div>
