...
<html lang="en">
   <head>
   @include('cms.partials.header-script')
   </head>
<body>
      ...
      <div class="main-wrapper">
         <div class="header">
            <div class="header-left active">
               <a href="#" class="logo">
               <img src="https://www.indiaprocess.com/images/logo1.png" alt="">
               </a>
               <a href="#" class="logo-small">
               <img src="{{ asset('/') }}{{ asset('/') }}assets/img/logo-small.png" alt="">
               </a>
            ...
            <ul class="nav user-menu">
               ...
               <li class="nav-item dropdown has-arrow flag-nav">
                  ...
                  <img src="{{ asset('/') }}assets/img/flags/india.jpg" alt="" height="20">
                  </a>
                  <div class="dropdown-menu dropdown-menu-right">
                     <a href="javascript:void(0);" class="dropdown-item">
                     <img src="{{ asset('/') }}assets/img/flags/india.jpg" alt="" height="16"> English
                     </a>
                  </div>
               </li>
            ...
            <div class="content">
               <div class="page-header">
                  <div class="page-title">
                     <h4>@section('pagetitle')
                        {{ config('app.name') }}
                        @show 
                     </h4>
                     <h6>@section('pageSubtitle')
                        {{ config('app.name') }}
                        @show
                     </h6>
                  </div>
        ...
        @include('cms.partials.footer-script')
      </body>
</html>